...
> Embed once the PNGs are committed under `submission_artifacts/`:
>
...
> Populate this table from `submission_artifacts/eval_untrained.json` and
> `submission_artifacts/eval_trained.json` after the eval notebook has run:
>
